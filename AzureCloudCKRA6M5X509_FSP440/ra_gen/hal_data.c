...
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x5f5e100,
  .duty_cycle_counts = 0x2faf080, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = g_gpt_timer_cb,
...
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x186a0,
  .duty_cycle_counts = 0xc350, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = TimerCallback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
