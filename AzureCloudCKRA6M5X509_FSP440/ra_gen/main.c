...
extern void HS3001_Thread_create(void);
extern void ZMOD4410_Thread_create(void);
extern void ICP_Thread_create(void);
extern void ICM_Thread_create(void);
extern void ZMOD4510_Thread_create(void);
extern void OB_1203_Thread_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    c2d_thread_create ();
    HS3001_Thread_create ();
    ZMOD4410_Thread_create ();
    ICP_Thread_create ();
    ICM_Thread_create ();
    ZMOD4510_Thread_create ();
    OB_1203_Thread_create ();
