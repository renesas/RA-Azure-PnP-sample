...
extern ewf_result cellular_init();
...
void application_thread_entry(void)
{
    ...
    do
    {
        ...
        if (TX_SUCCESS == status)
        {
            ...
            memset (&mq_data.value.led_data.led_act_topic_msg, '\0', sizeof(led_data_t));
        }
    }
    while (1);
}
