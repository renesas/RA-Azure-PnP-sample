...
{
    R_BSP_SoftwareDelay(50, BSP_DELAY_UNITS_MILLISECONDS);//vTaskDelay (50);
...
void autoOffsets(void)
{
    ...
    for (int i = 0; i < 50; i++)
    {
        ...
        accOffsetVal.z += accRawVal.z;
         R_BSP_SoftwareDelay(10, BSP_DELAY_UNITS_MILLISECONDS);//vTaskDelay (10);
    }
...
void resetMag(void)
{
    writeAK09916Register8 (AK09916_CNTL_3, 0x01);
     R_BSP_SoftwareDelay(100, BSP_DELAY_UNITS_MILLISECONDS);//vTaskDelay (100);
}
